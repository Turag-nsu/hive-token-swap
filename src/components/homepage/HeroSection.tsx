    ...
    return (
        <section className="container mx-auto px-4 pt-20 pb-16 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
                ...
                <MotionH1
                    className="text-4xl md:text-7xl font-futuristic-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-futuristic-blue via-futuristic-purple to-futuristic-cyan text-gradient relative"
                ...
                <MotionDiv
                    className="absolute bottom-1/3 right-1/3 w-16 h-16 rounded-full bg-gradient-to-r from-futuristic-orange/30 to-futuristic-indigo/30 blur-2xl animate-pulse"
                    animate={{
                        x: [0, -15, 0, 15, 0],
                        y: [0, 25, 0, -25, 0],
                        scale: [1, 1.3, 1, 1.2, 1],
                ...
                <MotionDiv
                    className="absolute top-2/3 left-1/3 w-20 h-20 rounded-full bg-gradient-to-r from-futuristic-violet/30 to-futuristic-green/30 blur-2xl animate-pulse"
                    animate={{
                        x: [0, 25, 0, -25, 0],
                        y: [0, -15, 0, 15, 0],
                        scale: [1, 1.1, 1, 1.3, 1],
